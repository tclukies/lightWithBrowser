...
const INDEX = path.join('http://localhost:3000/lock.html');
...
//   fs.readFile('https://pocket-lockit.firebaseapp.com/lock.html', function(err, data) { //read file index.html in public folder
//     if (err) {
